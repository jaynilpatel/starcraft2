...
for i in range(hm_epochs):
    ...
    while not_maximum:
        ...
        '''
        attack_choice = {"no_attacks": no_attacks,
               "attack_closest_to_nexus": attack_closest_to_nexus,
               "attack_enemy_structures": attack_enemy_structures,
               "attack_enemy_start": attack_enemy_start}
        train_data = []
        ...
        for attack in attack_choice:
            random.shuffle(attack_choice[attack])
            attack_choice[attack] = attack_choice[attack][:lowest_data]
            train_data = train_data + attack_choice[attack]
        ''' 
        ...
        model.fit(x_train, y_train, batch_size=batch_size, validation_data=(x_test, y_test), shuffle=True,
